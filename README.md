...
[![Release](https://img.shields.io/badge/Stable-2.2.2-green.svg)](https://github.com/wepsim/wepsim/releases/tag/v2.2.2)
...
+ From Linux/Unix command line, please:
  ...
  * Get WepSIM by executing:
    ```bash
    wget https://github.com/wepsim/wepsim/releases/download/v2.2.1/wepsim-2.2.1.zip
...
!wget https://github.com/wepsim/wepsim/releases/download/v2.2.1/wepsim-2.2.1.zip >& /dev/null
